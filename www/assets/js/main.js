var main = {
  ...
  "app": {
	...
	"undone_color": "grey lighten-1",
	"info_color": "blue lighten-1",
  },
  ...
  "phases": {
    ...
    "p1": {
      "phase": "Segurança",
	  "card_color": "teal",
      "description": "Crie um ambiente seguro para garantir o sono perfeito.",
      "description_full": "Um ambiente seguro é fundamental para uma boa noite de sono.",
      "steps": {
        "step1": {
          "step_name": "Portas Trancadas",
          "description": "Verifique todas as portas e janelas da casa.",
    ...
    "p2": {
      "phase": "O Quarto",
      "description": "Prepare o quarto para uma total absolção de temores e ansiedades.",
      "description_full": "Prepare o quarto para uma perfeita noite de sono. Com um quarto bem preparado nada poderá impedir você de descansar perfeitamente durante todas as horas necesárias para totalizar o mais perfeito dos sonos.",
      "steps": {
        "step1": {
